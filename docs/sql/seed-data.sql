...
--    detail_blocks 为结构化详情区块（text/image 图文混排）
-- ---------------------------------------------------------------------------
INSERT INTO `product`
(`id`, `product_no`, `category_id`, `brand`, `name`, `sub_title`, `price`, `original_price`,
 `main_image`, `images`, `detail_blocks`, `spec`, `sales`, `stock`, `tags`,
...
( 1, 'P20260831001', 1, NULL, '潮流运动鞋', '透气网面，轻弹缓震', 299.00, 599.00,
 ...
 JSON_ARRAY(JSON_OBJECT('type','text','content','透气网面，轻弹缓震'), JSON_OBJECT('type','image','url','/static/product-sneakers.jpg'), JSON_OBJECT('type','text','content','精选优质材料，匠心工艺，品质保证。')),
...
( 2, 'P20260831002', 1, NULL, '轻便休闲鞋', '一脚蹬设计，舒适百搭', 199.00, 359.00,
 '/static/product-sneakers.jpg', JSON_ARRAY('/static/product-sneakers.jpg'),
 JSON_ARRAY(JSON_OBJECT('type','text','content','一脚蹬设计，舒适百搭'), JSON_OBJECT('type','image','url','/static/product-sneakers.jpg'), JSON_OBJECT('type','text','content','精选优质材料，匠心工艺，品质保证。')),
...
( 3, 'P20260831003', 2, NULL, '简约单肩包', '优质皮料，百搭通勤', 159.00, 329.00,
 ...
 JSON_ARRAY(JSON_OBJECT('type','text','content','优质皮料，百搭通勤'), JSON_OBJECT('type','image','url','/static/product-bag.jpg'), JSON_OBJECT('type','text','content','精选优质材料，匠心工艺，品质保证。')),
...
( 4, 'P20260831004', 2, NULL, '复古水桶包', '大容量，时尚有型', 229.00, 459.00,
 '/static/product-bag.jpg', JSON_ARRAY('/static/product-bag.jpg'),
 JSON_ARRAY(JSON_OBJECT('type','text','content','大容量，时尚有型'), JSON_OBJECT('type','image','url','/static/product-bag.jpg'), JSON_OBJECT('type','text','content','精选优质材料，匠心工艺，品质保证。')),
...
( 5, 'P20260831005', 3, NULL, '无线降噪耳机', '主动降噪，40小时续航', 899.00, 1299.00,
 ...
 JSON_ARRAY(JSON_OBJECT('type','text','content','主动降噪，40小时续航'), JSON_OBJECT('type','image','url','/static/product-headphones.jpg'), JSON_OBJECT('type','text','content','精选优质材料，匠心工艺，品质保证。')),
...
( 6, 'P20260831006', 3, NULL, '真无线蓝牙耳机', '小巧便携，低延迟', 259.00, 469.00,
 '/static/product-headphones.jpg', JSON_ARRAY('/static/product-headphones.jpg'),
 JSON_ARRAY(JSON_OBJECT('type','text','content','小巧便携，低延迟'), JSON_OBJECT('type','image','url','/static/product-headphones.jpg'), JSON_OBJECT('type','text','content','精选优质材料，匠心工艺，品质保证。')),
...
( 7, 'P20260831007', 4, NULL, '保湿护肤套装', '补水修护，温和不紧绷', 219.00, 399.00,
 ...
 JSON_ARRAY(JSON_OBJECT('type','text','content','补水修护，温和不紧绷'), JSON_OBJECT('type','image','url','/static/product-skincare.jpg'), JSON_OBJECT('type','text','content','精选优质材料，匠心工艺，品质保证。')),
...
( 8, 'P20260831008', 4, NULL, '焕亮精华面膜', '深层滋养，提亮肤色', 129.00, 259.00,
 '/static/product-skincare.jpg', JSON_ARRAY('/static/product-skincare.jpg'),
 JSON_ARRAY(JSON_OBJECT('type','text','content','深层滋养，提亮肤色'), JSON_OBJECT('type','image','url','/static/product-skincare.jpg'), JSON_OBJECT('type','text','content','精选优质材料，匠心工艺，品质保证。')),
...
( 9, 'P20260831009', 5, NULL, '北欧风香薰套装', '清新怡人，舒缓放松', 89.00, 169.00,
 '/static/product-skincare.jpg', JSON_ARRAY('/static/product-skincare.jpg'),
 JSON_ARRAY(JSON_OBJECT('type','text','content','清新怡人，舒缓放松'), JSON_OBJECT('type','image','url','/static/product-skincare.jpg'), JSON_OBJECT('type','text','content','精选优质材料，匠心工艺，品质保证。')),
...
(10, 'P20260831010', 5, NULL, '云朵抱枕靠垫', '柔软亲肤，居家好物', 69.00, 129.00,
 '/static/product-skincare.jpg', JSON_ARRAY('/static/product-skincare.jpg'),
 JSON_ARRAY(JSON_OBJECT('type','text','content','柔软亲肤，居家好物'), JSON_OBJECT('type','image','url','/static/product-skincare.jpg'), JSON_OBJECT('type','text','content','精选优质材料，匠心工艺，品质保证。')),
